        ...
        <div className="relative overflow-hidden h-full">
          <div className="flex animate-scroll whitespace-nowrap h-full">
            ...
            <div className="flex items-center space-x-0 mr-0 h-full">
              {[...Array(25)].map((_, i) => (
                <h1 key={`first-${i}`} className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl xl:text-[10rem] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300 font-phosphate mobile-font tracking-tighter leading-none flex items-center h-full m-0 p-0" style={{fontStretch: 'ultra-condensed'}}>
                  FREE AI LOGO MAKER
                </h1>
              ))}
            </div>
            ...
            <div className="flex items-center space-x-0 mr-0 h-full">
              {[...Array(25)].map((_, i) => (
                <h1 key={`second-${i}`} className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl xl:text-[10rem] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300 font-phosphate mobile-font tracking-tighter leading-none flex items-center h-full m-0 p-0" style={{fontStretch: 'ultra-condensed'}}>
                  FREE AI LOGO MAKER
                </h1>
              ))}
            </div>
            ...
            <div className="flex items-center space-x-0 mr-0 h-full">
              {[...Array(25)].map((_, i) => (
                <h1 key={`third-${i}`} className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl xl:text-[10rem] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300 font-phosphate mobile-font tracking-tighter leading-none flex items-center h-full m-0 p-0" style={{fontStretch: 'ultra-condensed'}}>
                  FREE AI LOGO MAKER
                </h1>
              ))}
            </div>
